    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bookings.update", [$booking->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_name') ? 'is-invalid' : '' }}" type="text" name="car_name" id="car_name" value="{{ old('car_name', $booking->car_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_type') ? 'is-invalid' : '' }}" type="text" name="car_type" id="car_type" value="{{ old('car_type', $booking->car_type) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_year') ? 'is-invalid' : '' }}" type="number" name="car_year" id="car_year" value="{{ old('car_year', $booking->car_year) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_model') ? 'is-invalid' : '' }}" type="text" name="car_model" id="car_model" value="{{ old('car_model', $booking->car_model) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('type_of_service') ? 'is-invalid' : '' }}" name="type_of_service_id" id="type_of_service_id" required>
                    @foreach($type_of_services as $id => $entry)
                        <option value="{{ $id }}" {{ (old('type_of_service_id') ? old('type_of_service_id') : $booking->type_of_service->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_wheels') ? 'is-invalid' : '' }}" type="number" name="number_of_wheels" id="number_of_wheels" value="{{ old('number_of_wheels', $booking->number_of_wheels) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('extra_services') ? 'is-invalid' : '' }}" name="extra_services" id="extra_services">{{ old('extra_services', $booking->extra_services) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('preffered_date_time_of_booking') ? 'is-invalid' : '' }}" type="text" name="preffered_date_time_of_booking" id="preffered_date_time_of_booking" value="{{ old('preffered_date_time_of_booking', $booking->preffered_date_time_of_booking) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{!! old('message', $booking->message) !!}</textarea>
